...
L0L1coin.agregarTransaccion(tx1);
//Minando

L0L1coin.minarTransaccionesPendientes(myWalletAddress);

//Segunda Transaccion
const tx2 = new Transaction(myWalletAddress, 'address1', 50);
tx2.signTransaction(myKey);
L0L1coin.agregarTransaccion(tx2);
//Minando
L0L1coin.minarTransaccionesPendientes(myWalletAddress);
...
console.log();
console.log('Blockchain es valida?', L0L1coin.validarChain() ? 'Yes' : 'No');